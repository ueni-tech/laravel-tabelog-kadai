...
<div class="w-75">
  ...
  <form method="POST" action="{{route('dashboard.restaurants.update', $restaurant)}}" class="mb-5">
    @csrf
    @method('put')
    <div class="container">
